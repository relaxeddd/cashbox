...
import ru.cashbox.android.databinding.FragmentPreviewBinding
import ru.cashbox.android.model.EventType

class FragmentPreview : FragmentBase<ViewModelPreview, FragmentPreviewBinding>() {

    override fun getLayoutResId() = R.layout.fragment_preview
